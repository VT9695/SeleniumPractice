...
public class LocatorConcept {
	...
	public static void main(String[] args) {
		...
		//1. create the webelemets +perform the actions(sendkeys,gettext,idDisplayed,isEnabled
...
//			}
		...
		//6 Generic class ElementUtil class with generic methods so we can use all the method ovr the projects
//		
//		By username =By.id("input-email");
//		By pass =    By.id("input-password");
//		
